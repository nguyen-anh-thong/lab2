<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dondathang.aspx.cs" Inherits="lab2.dondathang" %>
            ...
            <div class="col-md-12">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6 border-top border-bottom border-primary">
                        <asp:Label ID="Label3" runat="server" Text="Danh sách bánh được đặt:"></asp:Label>
                      <br />
                ...
                <div class="row mb-2">
                    <div class="col-md-12 text-center">
                        <asp:Button ID="btIn" runat="server" OnClick="btIn_Click" CssClass="btn btn-info" Text="In Đơn" />
                    </div>
